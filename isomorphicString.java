...
/*
 * In this I have used 1 hashmap and 1 hashset to keep track of character to charactermatching. While traversing, finding if a character of
 * string s is already present in hash map or not. If it is not present, then create an entry and also add that to hashset. If it is already 
 * present then check if the value of character present matches character of t.
 */
